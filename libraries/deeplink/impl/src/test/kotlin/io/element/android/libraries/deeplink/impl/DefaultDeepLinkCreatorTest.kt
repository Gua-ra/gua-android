...
class DefaultDeepLinkCreatorTest {
    ...
    fun create() {
        ...
        assertThat(sut.create(sessionId, null, null, null))
            .isEqualTo("gua://open/%40alice%3Aserver.org")
        assertThat(sut.create(sessionId, roomId, null, null))
            .isEqualTo("gua://open/%40alice%3Aserver.org/%21aRoomId%3Adomain")
        assertThat(sut.create(sessionId, roomId, threadId, null))
            .isEqualTo("gua://open/%40alice%3Aserver.org/%21aRoomId%3Adomain/%24aThreadId")
        assertThat(sut.create(sessionId, roomId, threadId, eventId))
            .isEqualTo("gua://open/%40alice%3Aserver.org/%21aRoomId%3Adomain/%24aThreadId/%24anEventId")
        assertThat(sut.create(sessionId, roomId, null, eventId))
            .isEqualTo("gua://open/%40alice%3Aserver.org/%21aRoomId%3Adomain//%24anEventId")
    }
    ...
    fun `create - with escaped invalid characters`() {
        ...
        assertThat(sut.create(sessionId, roomId, null, null))
            .isEqualTo("gua://open/%40a%2F%3Adomain/%21a%2FRoomId%3Adomain")
        assertThat(sut.create(sessionId, roomId, threadId, null))
            .isEqualTo("gua://open/%40a%2F%3Adomain/%21a%2FRoomId%3Adomain/%24a%2FThreadId")
        assertThat(sut.create(sessionId, roomId, threadId, eventId))
            .isEqualTo("gua://open/%40a%2F%3Adomain/%21a%2FRoomId%3Adomain/%24a%2FThreadId/%24an%2FEventId")
        assertThat(sut.create(sessionId, roomId, null, eventId))
            .isEqualTo("gua://open/%40a%2F%3Adomain/%21a%2FRoomId%3Adomain//%24an%2FEventId")
    }
}
